...
import copy from "./RequestAccessResearchInstitutionManagerForm.copy";
...
class RequestAccessResearchInstitutionManagerForm extends Component<any, any> {
            ...
            <Form onSubmit={this.handleSubmit.bind(this)}>
              ...
              <Form.Row className="mt-3">
                <Form.Group as={Col} xs="6">
                  <Form.Label>{copy.form.labels.institutionName}</Form.Label>
                  <Form.Control
                    placeholder={copy.form.placeholders.institutionName}
                    size="lg"
                  />
                </Form.Group>
              </Form.Row>
...
export default RequestAccessResearchInstitutionManagerForm;
